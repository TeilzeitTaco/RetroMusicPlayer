package code.name.monkey.retromusic.patternlockview;

import static code.name.monkey.retromusic.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_HEIGHT_BIAS;
import static code.name.monkey.retromusic.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_SQUARE;
import static code.name.monkey.retromusic.patternlockview.PatternLockView.AspectRatio.ASPECT_RATIO_WIDTH_BIAS;
import static code.name.monkey.retromusic.patternlockview.PatternLockView.PatternViewMode.AUTO_DRAW;
import static code.name.monkey.retromusic.patternlockview.PatternLockView.PatternViewMode.CORRECT;
import static code.name.monkey.retromusic.patternlockview.PatternLockView.PatternViewMode.WRONG;
...
import code.name.monkey.retromusic.patternlockview.utils.PatternLockUtils;
import code.name.monkey.retromusic.patternlockview.utils.ResourceUtils;
